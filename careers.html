...
<!-- Mirrored from leap.mediumra.re/careers.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jun 2020 08:02:33 GMT -->
...
<head>
  ...
  <body>
    ...
    <div class="navbar-container ">
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-light bg-primary-alt">
        <div class="container">
          ...
          <div class="col-lg-10 col-xl-8">
            <div data-flickity='{ "imagesLoaded": true, "wrapAround": true }' class="mb-5">
              <div class="carousel-cell mx-3">
                <img src="assets/img/inner-5.jpg" alt="Image" class="rounded">
              </div>
              <div class="carousel-cell mx-3">
                <img src="assets/img/article-1.jpg" alt="Image" class="rounded">
              </div>
              <div class="carousel-cell mx-3">
                <img src="assets/img/article-8.jpg" alt="Image" class="rounded">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-xl-10">
            ...
            <div class="list-group list-group-flush">
              <a href="#" class="list-group-item list-group-item-action row no-gutters py-3">
                <div class="col-xl-8 col-lg-7 col-md-6">
                  <h5 class="mb-0">Advanced Manufacturing Engineer</h5>
                </div>
                <div class="col-md">
              ...
              <a href="#" class="list-group-item list-group-item-action row no-gutters py-3">
                <div class="col-xl-8 col-lg-7 col-md-6">
                  <h5 class="mb-0">AI Research Scientist</h5>
                </div>
                <div class="col-md">
                  <span>Engineering</span>
                </div>
              ...
              <a href="#" class="list-group-item list-group-item-action row no-gutters py-3">
                <div class="col-xl-8 col-lg-7 col-md-6">
                  <h5 class="mb-0">Senior Software Engineer</h5>
                </div>
                <div class="col-md">
                  <span>Engineering</span>
                </div>
              ...
              <a href="#" class="list-group-item list-group-item-action row no-gutters py-3">
                <div class="col-xl-8 col-lg-7 col-md-6">
                  <h5 class="mb-0">Director, Brand Design</h5>
                </div>
                <div class="col-md">
                  <span>Marketing</span>
                </div>
            ...
            <span class="d-block mt-4">Didn't see your job? <a href="#" class="hover-arrow">Drop your resumé</a>
            </span>
          </div>
        </div>
      </div>
...
<!-- Mirrored from leap.mediumra.re/careers.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jun 2020 08:02:38 GMT -->
</html>
