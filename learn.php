      ...
      <div class="container layer-2">
        <div class="row justify-content-center pt-lg-5">
          <div class="col-xl-5 col-lg-6 col-md-7 text-center text-lg-left mb-5 mb-lg-0">
            ...
            <div class="my-4">
              <p class="lead">Not sure where to begin? No need to worry, we’ll help you make sense of it all.</p>
            </div>
              ...
              <div class="col-xl-8 col-md-10">
                <form>
                  ...
                  <div class="form-group">
                    ...
                    <input name="course-email" id="course-email-1" type="email" class="form-control form-control-lg" placeholder="johndoe@anything.com">
                  </div>
                  <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col">
                      <div class="form-group rounded bg-white p-2 border">
                        <div class="custom-control custom-radio">
                          ...
                          <label class="custom-control-label" for="course-radio-beginner-1">Web Design</label>
                        </div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-group rounded bg-white p-2 border">
                        <div class="custom-control custom-radio">
                          ...
                          <label class="custom-control-label" for="course-radio-advanced-1">Web Development</label>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row align-items-center justify-content-around">
          ...
          <div class="col-xl-5 col-md-6">
            <div class="h1">
              <div>Howdy, I'm TeeGee,</div>
              <span>A</span>
              <div class="highlight">
                <span data-typed-text data-loop="true" data-type-speed="65" data-strings='["front-end developer","graphic designer","brand strategist","fullstack developer","UI/UX designer"]'></span>
              </div>
            </div>
            <p class="lead">When am not coding, cooking, designing, watching movies, listening to music and swimming, then am out there living my best life.</p>
              <div class="row">
                <div class="col-auto">
                    <ul class="nav">
                        <li class="nav-item">
          ...
          <div class="col-xl-6 col-lg-5 col-md-6">
            <form>
              ...
              <div class="form-group">
                ...
                <input name="course-email" id="course-email-2" type="email" class="form-control form-control-lg" placeholder="johndoe@anything.com">
              </div>
              <div class="row">
                <div class="col-12">
                  <div class="form-group mb-1">
                ...
                <div class="col">
                  <div class="form-group rounded bg-white p-2 border">
                    <div class="custom-control custom-radio">
                      ...
                      <label class="custom-control-label" for="course-radio-beginner-2">Web Design</label>
                    </div>
                  </div>
                </div>
                <div class="col">
                  <div class="form-group rounded bg-white p-2 border">
                    <div class="custom-control custom-radio">
                      ...
                      <label class="custom-control-label" for="course-radio-advanced-2">Web Development</label>
                    </div>
                  </div>
                </div>
              </div>
