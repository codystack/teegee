      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-5 col-lg-6 col-md-8">
            ...
            <p class="lead mb-0">If you're reading this then you are on the right path. Just take one step at a time and you will be alright.😃</p>
          </div>
        </div>
      </div>
      <div class="divider">
    ...
    <section>
      <div class="container">
        <div class="row mb-4">
            ...
            <a href="#" class="card card-body justify-content-between bg-primary text-light">
              <div class="d-flex justify-content-between mb-3">
                ...
                <span class="badge bg-primary-alt text-primary">
                  <img class="icon icon-sm bg-primary" src="assets/img/icons/interface/heart.svg" alt="heart interface icon" data-inject-svg />27
                </span>
              </div>
              <div>
            ...
            <div class="card">
              ...
              <div class="card-body d-flex flex-column">
                <div class="d-flex justify-content-between mb-3">
                  ...
                  <span class="badge bg-primary-alt text-primary">
                    <img class="icon icon-sm bg-primary" src="assets/img/icons/interface/heart.svg" alt="heart interface icon" data-inject-svg />23
                  </span>
                </div>
                <a href="#">
          ...
          <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="400">
            <div class="card">
              <a href="#">
              ...
              <div class="card-body d-flex flex-column">
                <div class="d-flex justify-content-between mb-3">
                  ...
                  <span class="badge bg-primary-alt text-primary">
                    <img class="icon icon-sm bg-primary" src="assets/img/icons/interface/heart.svg" alt="heart interface icon" data-inject-svg />82
                  </span>
                </div>
                <a href="#">
            ...
            <div class="card card-body justify-content-between bg-primary-2 text-light">
              <div class="d-flex justify-content-between mb-3">
                ...
                <span class="badge bg-primary text-light">
                  <img class="icon icon-sm bg-white" src="assets/img/icons/interface/heart.svg" alt="heart interface icon" data-inject-svg />93
                </span>
              </div>
              <div>
          ...
          <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="600">
            <div class="card">
              <a href="#">
              ...
              <div class="card-body d-flex flex-column">
                <div class="d-flex justify-content-between mb-3">
                  ...
                  <span class="badge bg-primary-alt text-primary">
                    <img class="icon icon-sm bg-primary" src="assets/img/icons/interface/heart.svg" alt="heart interface icon" data-inject-svg />93
                  </span>
                </div>
                <a href="#">
          ...
          <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="700">
            <div class="card">
              <a href="#">
                <img src="assets/img/article-5.jpg" alt="Image" class="card-img-top">
              </a>
              <div class="card-body d-flex flex-column">
                <div class="d-flex justify-content-between mb-3">
                  <div class="text-small d-flex">
                    ...
                    <span class="text-muted">10th November</span>
                  </div>
                  <span class="badge bg-primary-alt text-primary">
                    <img class="icon icon-sm bg-primary" src="assets/img/icons/interface/heart.svg" alt="heart interface icon" data-inject-svg />41
                  </span>
                </div>
                <a href="#">
                ...
                <div class="d-flex align-items-center mt-3">
                  ...
                  <div class="ml-1">
                    <span class="text-small text-muted">By</span>
                    <span class="text-small">Anwar K.</span>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="800">
            <div class="card">
              <a href="#">
                <img src="assets/img/article-6.jpg" alt="Image" class="card-img-top">
              </a>
              <div class="card-body d-flex flex-column">
                <div class="d-flex justify-content-between mb-3">
                  <div class="text-small d-flex">
                    ...
                    <span class="text-muted">4th November</span>
                  </div>
                  <span class="badge bg-primary-alt text-primary">
                    <img class="icon icon-sm bg-primary" src="assets/img/icons/interface/heart.svg" alt="heart interface icon" data-inject-svg />96
                  </span>
                </div>
                <a href="#">
                ...
                <div class="d-flex align-items-center mt-3">
                  <img src="assets/img/avatars/male-5.jpg" alt="Image" class="avatar avatar-sm">
                  <div class="ml-1">
                    <span class="text-small text-muted">By</span>
                    <span class="text-small">James</span>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="900">
            <div class="card card-body justify-content-between bg-primary-3 text-light">
              <img src="assets/img/article-7.jpg" alt="Image" class="bg-image opacity-20">
              <div class="d-flex justify-content-between mb-3 position-relative">
                <div class="text-small d-flex">
                  <div class="mr-2">
                    <a href="#">Videos</a>
                  </div>
                  <span class="opacity-70">7th November</span>
                </div>
                <span class="badge bg-primary text-light">
              ...
              <div class="d-flex position-relative">
                ...
                <div class="ml-3">
                  <a href="#">
                    <h4 class="mb-1">Planning for change documentary</h4>
                  </a>
          ...
          <div class="col-md-6 col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="1000">
            <div class="card card-body bg-primary-2 text-light">
              <div class="d-flex justify-content-between mb-3">
                ...
                <span class="badge bg-primary text-light">
                  <img class="icon icon-sm bg-white" src="assets/img/icons/interface/heart.svg" alt="heart interface icon" data-inject-svg />121
                </span>
              </div>
              <div class="d-flex">
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-xl-7 col-lg-8 col-md-10">
            <h3 class="h2 mb-5">Get the latest tutorials direct to your inbox</h3>
            <form action="https://mailform.mediumra.re/leap/mailchimp.php" data-form-email novalidate>
              <div class="d-sm-flex flex-column flex-sm-row mb-3 justify-content-center">
                ...
                <div data-recaptcha data-sitekey="6Lffn6wZAAAAAAugzAxCAAtRnt51FglCvz8Gb24F" data-size="invisible" data-badge="bottomleft"></div>
            ...
            <div class="text-small text-muted">
              ...
              <br class="visible-md" />View my <a href="privacy-policy">Privacy Policy</a> for more info.
            </div>
          </div>
        </div>
      </div>
