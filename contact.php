...
<!-- Mirrored from leap.mediumra.re/contact-multiple-locations.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jun 2020 08:02:41 GMT -->
...
<head>
  ...
  <body>
    ...
    <div class="navbar-container ">
      <nav class="navbar navbar-expand-lg navbar-light bg-primary-alt">
        <div class="container">
          ...
          <div class="col">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Contact Multiple Locations</li>
              </ol>
            </nav>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-around">
          <div class="col-md-7 col-lg-6 mb-3 mb-md-0">
            <div class="min-vh-50 w-100 rounded shadow-3d" data-marker-image="assets/img/map-marker-2.svg" data-maps-api-key="AIzaSyBwEEJvsorMxyHy1Wt44QN_aW08HAOektw" data-address="389 Greenpoint Ave, Crown Heights, Brooklyn New York" data-map-zoom="14">
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-8 pb-2">
                        ...
                        <a target="_blank" href="https://themes.getbootstrap.com/product/leap-multipurpose-bootstrap-theme/">... More Info</a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <section class="pt-0">
      <div class="container">
        <div class="row justify-content-around">
          <div class="col-md-7 col-lg-6 mb-3 mb-md-0">
            <div class="min-vh-50 w-100 rounded shadow-3d" data-marker-image="assets/img/map-marker-2.svg" data-maps-api-key="AIzaSyBwEEJvsorMxyHy1Wt44QN_aW08HAOektw" data-address="2213 Montgomery Street, The East Cut, San Francisco, California" data-map-zoom="14">
              <div class="map-marker" data-address="2213 Montgomery Street, The East Cut, San Francisco, California">
                <div class="info-window" data-max-width="400">
                  <div class="container">
                    <div class="row">
                      <div class="col-12">
                      ...
                      <div class="col-8 pb-2">
                        ...
                        <h6 class="mb-0">Address</h6>
                        <address>
                          2213 Montgomery Street
                          <br>The East Cut, San Francisco
                          <br>California
                        </address>
                        <a target="_blank" href="https://themes.getbootstrap.com/product/leap-multipurpose-bootstrap-theme/">... More Info</a>
                      </div>
    ...
    <section class="pt-0">
      <div class="container">
        <div class="row justify-content-around">
          <div class="col-md-7 col-lg-6 mb-3 mb-md-0">
            <div class="min-vh-50 w-100 rounded shadow-3d" data-marker-image="assets/img/map-marker-2.svg" data-maps-api-key="AIzaSyBwEEJvsorMxyHy1Wt44QN_aW08HAOektw" data-address="4928 Lincoln Boulevard, Santa Monica, Los Angeles, California" data-map-zoom="14">
              <div class="map-marker" data-address="4928 Lincoln Boulevard, Santa Monica, Los Angeles, California">
                <div class="info-window" data-max-width="400">
                  <div class="container">
                    <div class="row">
                      <div class="col-12">
                      ...
                      <div class="col-8 pb-2">
                        ...
                        <h6 class="mb-0">Address</h6>
                        <address>
                          4928 Lincoln Boulevard
                          <br>Santa Monica, Los Angeles
                          <br>California
                        </address>
                        <a target="_blank" href="https://themes.getbootstrap.com/product/leap-multipurpose-bootstrap-theme/">... More Info</a>
                      </div>
...
<!-- Mirrored from leap.mediumra.re/contact-multiple-locations.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jun 2020 08:02:42 GMT -->
</html>
